    ...
    <div class="space-y-6">
        <x-common.component-card title="Portfolio Details">
            ...
            <div>
                ...
                <p class="break-all font-mono text-sm text-gray-600 dark:text-gray-400">{{ $portfolio->slug }}</p>
            </div>

            {{-- Created At --}}
            <div>
                <p class="mb-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Created At</p>
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ $portfolio->created_at->format('d M Y, H:i') }}</p>
            </div>
