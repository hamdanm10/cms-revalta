<form action="{{ route('admin.portfolios.update', $portfolio) }}" method="POST" enctype="multipart/form-data"
    x-data="{
        title: '{{ old('title', $portfolio->title) }}',
            ...
            <x-common.component-card title="Portfolio Details">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" x-model="title"
                        @input="generateSlug($event.target.value)" value="{{ old('title', $portfolio->title) }}"
                ...
                <div>
                    ...
                    <input type="text" id="short_description" name="short_description"
                        value="{{ old('short_description', $portfolio->short_description) }}"
                ...
                <div>
                    ...
                    <x-form.quill-editor name="description" :value="old('description', $portfolio->description)"
