<div id="portfolios-table"
    x-data="{ deleteAction: '' }"
    data-search-url="{{ route('admin.portfolios.search') }}">
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="border-b border-gray-100 px-5 py-4 dark:border-gray-800">
            <div class="flex flex-wrap items-center justify-end gap-3">
                {{-- Search --}}
                <input id="portfolio-search" type="search" value="{{ $search }}"
        ...
        <div id="portfolios-results">
            @include('components.admin.portfolios.partials.results', ['portfolios' => $portfolios])
        </div>
    ...
    <x-ui.modal class="max-w-sm p-6" :show-close-button="false" @open-delete-modal.window="open = true">
        ...
        <h4 class="mb-2 text-center text-base font-semibold text-gray-800 dark:text-white/90">Delete Portfolio?</h4>
        <p class="mb-6 text-center text-theme-sm text-gray-500 dark:text-gray-400">Are you sure you want to delete this portfolio?</p>
