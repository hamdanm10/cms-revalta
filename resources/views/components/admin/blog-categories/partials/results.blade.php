            ...
            @forelse($blogCategories as $category)
                <tr class="border-b border-gray-100 dark:border-gray-800">
                    <td class="px-5 py-4 sm:px-6">
                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $blogCategories->firstItem() + $loop->index }}</p>
                    </td>
                    <td class="px-5 py-4 sm:px-6">
                    ...
                    <td class="px-5 py-4 sm:px-6">
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button"
                                @click="deleteAction = '{{ route('admin.blog-categories.destroy', $category) }}'; $dispatch('open-delete-modal')"
