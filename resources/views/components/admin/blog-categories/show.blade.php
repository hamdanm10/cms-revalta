<div class="space-y-6">
    <x-common.component-card title="Details">
        ...
        <div>
            ...
            <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $blogCategory->name }}</p>
        </div>

        {{-- Slug --}}
        <div>
            <p class="mb-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Slug</p>
            <p class="break-all font-mono text-sm text-gray-600 dark:text-gray-400">{{ $blogCategory->slug }}</p>
        </div>

        {{-- Created At --}}
        <div>
            <p class="mb-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Created At</p>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ $blogCategory->created_at->format('d M Y, H:i') }}</p>
        </div>

        {{-- Updated At --}}
        <div>
            <p class="mb-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Updated At</p>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ $blogCategory->updated_at->format('d M Y, H:i') }}</p>
        </div>
