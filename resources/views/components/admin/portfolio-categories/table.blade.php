<div id="portfolio-categories-table"
    x-data="{ deleteAction: '' }"
    data-search-url="{{ route('admin.portfolio-categories.search') }}">
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="border-b border-gray-100 px-5 py-4 dark:border-gray-800">
            <div class="flex flex-wrap items-center justify-end gap-3">
                <input id="portfolio-category-search" type="search" value="{{ $search }}"
        ...
        <div id="portfolio-categories-results">
            @include('components.admin.portfolio-categories.partials.results', ['portfolioCategories' => $portfolioCategories])
        </div>
